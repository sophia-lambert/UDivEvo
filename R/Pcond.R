#' Calculating the conditionning of the birth-death process on the age of the process and its survival.
#'
...
#'
#' @return The probabillity of the birth-death process starting with one lineage at time t and surviving at present.
#'
#' @author Sophia Lambert
#'

#\code{\link{likelihood_bdRho}}, \code{\link{fitMCMC_bdRho}}
