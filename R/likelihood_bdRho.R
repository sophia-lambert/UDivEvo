...
#' @param unif Logical. If \code{TRUE} a uniform distribution is assumed on the sampling probabilitie(s). Note that the parameters of the uniform distribution can be fixed or inferred and can be specified in the function generated by the function \code{likelihood_bdRho} using the arguments \code{a} for the lower bound of the uniform distribution (\eqn{a >= 0}) and \code{b} for the higher bound of the uniform distribution (\eqn{b\le0} and (\eqn{b >= a})).
