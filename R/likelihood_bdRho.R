...
#'   \item{tun.init}{Numeric vector. The initial tuning parameters values. Typically, it will take the value \eqn{\log_{10} 1}. The length of the numeric vector equals the number of phylogenie(s) used.}
